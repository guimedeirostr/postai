...
7. visual_prompt em inglês:${referenceDnaVisualPrompt ? `
   ...
   Descreva cena real, fotografia profissional, lighting, estilo. NÃO descreva textos, logos ou elementos gráficos na imagem. O visual_prompt descreve APENAS a foto pura — sem menção a texto, palavras ou overlays tipográficos.`}
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━
{
  ...
  "visual_prompt": "${referenceDnaVisualPrompt ? `Start from the reference base prompt and adapt ONLY the subject to the current theme. Preserve exact lighting, camera angle, background, color mood, photographic style. Write in English. No text, words, or typography in the image.` : hasReferenceImage ? "detailed professional photography/design prompt in English — replicate the exact style, color palette, composition and mood of the reference image above. Do NOT use brand colors. No text, words, or typography in the image." : `detailed professional photography prompt in English with scene, lighting, mood, style, brand colors ${client.primary_color} and ${client.secondary_color}. No text, words, or typography in the image.`}",
